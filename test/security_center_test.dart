...
final class FakeSecurityService implements AccountSecurityService {
  ...
  Future<List<DeviceSummary>> listDevices() async => [
        DeviceSummary(
          ...
          platform: 'android',
          state: revoked ? DeviceLifecycleState.revoked : DeviceLifecycleState.active,
  ...
  @override
  Future<void> revokeDevice(String deviceId, {required int expectedRevision}) async {
  ...
  @override
  Future<void> approveDevice(String deviceId, {required int expectedRevision}) async {}

  @override
  Future<void> beginTrustedDeviceEnrollment({required String deviceName, required String platform, required Uint8List publicPreKeyBundle, required LocalUnlockPolicy localUnlock}) async {}

  @override
  Future<RecoveryChannelSummary> addRecoveryChannel({required RecoveryChannelKind kind, required String destination}) => throw UnimplementedError();

  @override
  Future<void> removeRecoveryChannel(String channelId) async {}

  @override
  Future<RecoveryChallenge> requestChallenge(String channelId, RecoveryPurpose purpose) => throw UnimplementedError();

  @override
  Future<void> suspendDevice(String deviceId, {required int expectedRevision}) async {}
