...
check was introduced: **315 findings across 30 files
and 5,913 lines**. CI compares against that budget and fails only when a
...
| `DA008` | 73 | warn | pure transformations | in-place collection mutation |
| `DA003` | 65 | warn | immutable values | mutable (non-`final`) instance field |
...
*pure transformations* · 73 occurrences at baseline
...
*immutable values* · 65 occurrences at baseline
